...
public class BoolGUI extends CustomGUI {
    private static final ItemStack trueItem = new ItemBuilder(Material.GREEN_TERRACOTTA,1).setName("<green>True").build();
    private static final ItemStack falseItem = new ItemBuilder(Material.RED_TERRACOTTA,1).setName("<red>False").build();
